...
export default function ReplayInput() {
  const { sendReply, reply, setReply } = useMessagesContext();
    ...
    <div className="p-4 border-t border-gray-700 bg-gray-800">
      <div className="flex items-end gap-2">
        ...
        <button
          onClick={sendReply}
          disabled={!reply.trim()}
          className="bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors"
        >
          <svg
